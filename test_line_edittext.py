...
print (MR.leftText)
ex = Example()
ex.textEdit1.setMergeText(MR.leftText, MR.diffs)
ex.textEdit3.setMergeText(MR.rigthText, MR.diffs, False)
ex.textEdit2.setMergeText(MR.GetMergedText(), MR.diffs, None)
# ex.textEdit1.edit.appendPlainText("q")
# ex.textEdit1.edit.appendPlainText("")
# ex.textEdit1.edit.appendPlainText("")
ex.show()
print("After show()")
